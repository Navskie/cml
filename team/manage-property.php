...
<script>
  $(document).ready(function() {
    ...
    var imageUrl = (window.location.hostname === 'localhost') ? '../img' : 'https://cml-realty.com/img';
            ...
            if (response.length > 0) {
                ...
                response.forEach(function(amenity) {
                    var amenityHtml = '<div class="group d-flex flex-column align-items-center amenity-item" data-filename="' + amenity.filename + '">' +
                        '<img src="' + imageUrl + '/amenities/' + amenity.filename + '" style="width: 100%;">' +
          ...
          success: function(response) {
              if (response.status === 'success') {
                  ...
                  response.data.forEach(function(image) {
                      ...
                      var imagePath = `${imageUrl}/properties/${image.property_id}/${image.filename}`;
